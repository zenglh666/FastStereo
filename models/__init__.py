...
from .fastg2 import PSMNet as fastg2
from .fastg3 import PSMNet as fastg3
...
def get_model(args):
    if args.model == 'stackhourglass':
        ...
        model = faste6(args)
    elif args.model == 'fastf1':
        model = fastf1(args)
    elif args.model == 'fastf2':
        model = fastf2(args)
    elif args.model == 'fastf3':
        model = fastf3(args)
    elif args.model == 'fastg1':
        model = fastg1(args)
    elif args.model == 'fastg2':
        model = fastg2(args)
    elif args.model == 'fastg3':
        model = fastg3(args)
    else:
