...
class PSMNet(nn.Module):
    def __init__(self, args):
        ...
        self.feature_extraction = nn.Sequential(
            nn.Conv2d(3, self.planes, kernel_size=15, stride=8, padding=7, dilation=1, bias=False),
        ...
        self.classifier = nn.Sequential(
            nn.ConvTranspose3d(inplanes, 1, kernel_size=15, stride=8, padding=7, output_padding=7, dilation=1, bias=False)
        )
