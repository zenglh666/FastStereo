...
class PSMNet(nn.Module):
    def __init__(self, args):
        ...
        self.feature_extraction = nn.Sequential(
            ...
            block2d(args.planes*4, args.planes, kernel_size=3,  padding=args.dilation, dilation=args.dilation),
            block2d(args.planes*5, args.planes, kernel_size=3,  padding=args.dilation, dilation=args.dilation),
            block2d(args.planes*6, args.planes, kernel_size=3,  padding=args.dilation, dilation=args.dilation),
            block2d(args.planes*7, args.planes, kernel_size=3,  padding=args.dilation, dilation=args.dilation),
        )
        ...
        self.fuse = nn.Sequential(
            ...
            block3d(args.planes*4, args.planes, kernel_size=3,  padding=args.dilation, dilation=args.dilation),
            block3d(args.planes*5, args.planes, kernel_size=3,  padding=args.dilation, dilation=args.dilation),
            block3d(args.planes*6, args.planes, kernel_size=3,  padding=args.dilation, dilation=args.dilation),
            block3d(args.planes*7, args.planes, kernel_size=3,  padding=args.dilation, dilation=args.dilation),
        ) 

        inplanes = self.planes * 8

        self.classifier = nn.Sequential(
            nn.ConvTranspose3d(inplanes, self.planes, kernel_size=3, stride=2, padding=1, output_padding=1, dilation=1, bias=False),
            nn.BatchNorm3d(self.planes),
            nn.ReLU(inplace=True),
            nn.ConvTranspose3d(self.planes, 1, kernel_size=7, stride=4, padding=3, output_padding=3, dilation=1, bias=False)
    )
